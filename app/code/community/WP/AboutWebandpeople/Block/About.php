...
class WP_AboutWebandpeople_Block_About
...
<div style="background-color:#EAF0EE;border:1px solid #CCCCCC;margin-bottom:10px;padding:20px;">
    ...
    <p>
        ...
        Should you have any questions <a href="http://web-experiment.info/support" target="_blank">Contact Us</a> or email at <a href="mailto:{@emailSupport}">{@emailSupport}</a>
        <br />
    </p>
</div>
HTML;
